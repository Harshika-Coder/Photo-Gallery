                  ...
                  services={[
                    {
                      ...
                      image: img3,
                      description:
                        "High-quality visuals for brands, ads, and campaigns.",
                    },
                    {
                      name: "Wedding Photography",
                      image: img7,
                      description:
                        "Capturing timeless memories of your big day.",
                    },
                    {
                      name: "Pre-Wedding Shoots",
                      image: img9,
                      description:
                        "Romantic storytelling before the wedding day.",
                    },
                    {
                      name: "Event Coverage",
                      image: img11,
                    ...
                    },
                    {
                      ...
                      image: img6,
                      description:
                        "Detailed shots to make your products shine.",
                    },
                    {
                      name: "Documentaries",
                      image: img15,
                      description:
                        "Visual storytelling for impactful narratives.",
                    },
                  ]}
                />
                <Blog
                ...
                <Booking
                  ...
                  onSubmit={(e) => {
                    ...
                    if (type === "testimonial") {
                      ...
                      alert(
                        `Thank you, ${name}! Your testimonial has been added.`,
                      );
                    } else {
                      alert(
